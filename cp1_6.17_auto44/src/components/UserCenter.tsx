    ...
    <div className="user-center">
      ...
      <section className="user-section">
        <h2 className="section-title">
          <span className="status-badge status-matched">✅ 已匹配</span>
          <span className="section-count">{matchedApps.length}</span>
        </h2>
      ...
      <section className="user-section">
        <h2 className="section-title">
          <span className="status-badge status-matching">⏳ 匹配中</span>
          <span className="section-count">{matchingApps.length}</span>
        </h2>
