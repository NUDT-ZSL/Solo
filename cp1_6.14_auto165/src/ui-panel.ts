...
export class UIPanel {
  ...
  constructor() {
    ...
    this.coordXEl.style.cssText = 'color: #fff; min-width: 40px; display: inline-block;';
    const yLabel = document.createElement('span');
    yLabel.textContent = 'Y:';
    yLabel.style.cssText = 'color: rgba(255,255,255,0.6);';
    this.coordYEl = document.createElement('span');
    this.coordYEl.style.cssText = 'color: #fff; min-width: 40px; display: inline-block;';
    ...
    this.speedEl.style.cssText = 'color: #f97316; font-size: 20px; font-weight: 700; font-family: "Courier New", monospace; text-shadow: 0 0 8px rgba(249, 115, 22, 0.6);';
    ...
    this.densityFillEl.style.cssText = 'height: 100%; width: 0%; border-radius: 5px; background: linear-gradient(90deg, rgba(10,10,46,0.1), rgba(59,7,100,0.5), rgba(112,26,117,0.8)); transition: width 0.2s ease; box-shadow: 0 0 12px rgba(112, 26, 117, 0.5);';
    this.densityValueEl = document.createElement('span');
    this.densityValueEl.style.cssText = 'position: absolute; right: 0; top: -16px; font-size: 11px; color: rgba(255,255,255,0.7); font-family: "Courier New", monospace;';
