...
export function App() {
  ...
  const handleMouseDown = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      const building = buildingsRef.current.find((b) => b.x === cell.x && b.y === cell.y)
      if (building) {
        engineRef.current?.clickBuilding(building)
...
function BuildingCell({ building, transitionKey }: BuildingCellProps) {
