...
const seedBooks = [
  ...
  { id: '11', title: '2001太空漫游', author: '阿瑟·克拉克', category: '科幻', price: 42.00, isbn: '9787536452992', publishDate: '2007-11-01', pages: 275, stock: 16, cover: 'https://picsum.photos/seed/2001/400/560', description: '一块神秘的黑色石板，穿越时空，连接起人类的过去与未来。', authorIntro: '阿瑟·克拉克，英国科幻小说家。' },
  ...
  { id: '13', title: '史记', author: '司马迁', category: '历史', price: 98.00, isbn: '9787101057645', publishDate: '2010-01-01', pages: 2480, stock: 10, cover: 'https://picsum.photos/seed/sj/400/560', description: '中国第一部纪传体通史，记载了上自黄帝下至汉武帝共3000多年的历史。', authorIntro: '司马迁，字子长，西汉夏阳人，中国古代伟大的史学家、思想家、文学家。' },
...
async function initDB() {
  ...
  if (count === 0) {
    ...
    console.log(`✅ 已插入 ${seedBooks.length} 本书`);
  }
}
